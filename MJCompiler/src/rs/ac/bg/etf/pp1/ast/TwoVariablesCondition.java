...
public class TwoVariablesCondition extends ConditionFact {

    private Expr Expr;
    private RelationalOperator RelationalOperator;
    private Expr Expr1;

    public TwoVariablesCondition (Expr Expr, RelationalOperator RelationalOperator, Expr Expr1) {
        this.Expr=Expr;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("TwoVariablesCondition(\n");
